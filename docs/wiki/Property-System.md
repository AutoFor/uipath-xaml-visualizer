...
![アクティビティカード・プロパティ](images/activity-card-properties.svg)

*[draw.io ソース](wiki-diagrams.drawio)*
...
![プロパティ分類フローチャート](images/property-classification-flow.svg)
...
![差分プロパティ分類フローチャート](images/diff-property-classification-flow.svg)
