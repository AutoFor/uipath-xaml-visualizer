...
![ワークフロー可視化](docs/images/workflow-visualization.svg)

*[draw.io ソース](docs/spec.drawio)*
...
![詳細パネル](docs/images/activity-detail-panel.svg)
...
![スクリーンショット表示（カード内）](docs/images/screenshot-card.svg)

*[draw.io ソース](docs/spec.drawio)*

**拡大表示（モーダル）:**

![スクリーンショット表示（モーダル）](docs/images/screenshot-modal.svg)
...
![スクリーンショット表示（エラー）](docs/images/screenshot-error.svg)
...
![スクリーンショット比較](docs/images/screenshot-comparison.svg)
...
![プロパティ差分](docs/images/property-diff.svg)
...
![差分サマリー](docs/images/diff-summary.svg)
...
![変更サマリーレポート](docs/images/change-summary-report.svg)
...
![Azure DevOps アーキテクチャ](docs/images/azure-devops-architecture.svg)
...
![テストピラミッド](docs/images/test-pyramid.svg)
